...
class UserControllerTest {
    ...
    void signupSuccess() throws Exception {
        ...
        SignUpResponseDto responseDto = new SignUpResponseDto(nickname, role.name(), accessToken);
    ...
    void signupInvalidRoleInput() throws Exception {
        // given
        UserSignUpRequestDto requestDto = new UserSignUpRequestDto("testProviderId", null);
